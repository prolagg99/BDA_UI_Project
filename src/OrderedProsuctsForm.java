 ...
 * @author MEBA
 */
public class OrderedProsuctsForm extends javax.swing.JFrame {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        AddProductForm ap = new AddProductForm("ordredProducts");
        ap.show();
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderedProsuctsForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
